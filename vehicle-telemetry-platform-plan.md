...
| 기간 | 내용 |
|------|------|
| 2026.03 1~2주 | 환경 구성, 시뮬레이터, MQTT + Kafka 파이프라인 |
| 2026.03 3~4주 | Spring Boot API 서버, DB 연동 |
| 2026.04 5~6주 | 이상 감지 모듈, 알림 시스템 |
| 2026.04 7~8주 | 보안 강화, Grafana 대시보드 |
| 2026.05 9~10주 | Docker화, 배포, README 및 아키텍처 문서 작성 |
| 2026.05~ | 테스트 코드, 부하 테스트, 보안 심화 (진행 중) |
