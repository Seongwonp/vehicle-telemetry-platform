...
| 27 | 파티션 24·인스턴스 8까지 재스윕 — **천장을 찾았다: 약 57,000 msg/s.** 서로 다른 두 구성(파티션 12·4개 = 57,864 / 파티션 24·8개 = 56,985)이 **1.5% 안에서 일치**. **CPU는 범인이 아니다** — 호스트 923%/1600%, backend CPU 합이 4개→8개에서 142→147로 정체 | 완료(1회) |
